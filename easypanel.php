...
function easypanel_ConfigOptions() {
	...
	# 应返回的每个产品的模块选项数组 - 最多24个
	# 本接口于 2016.8.14 进行修改

    $configarray = array(
		 "CDN"				=> array("Type" => "yesno", "Description" => "CDN网站"),				//1
		 "空间类型"			=> array("Type" => "text", "Size" => "5"),							//2
	     ...
	     "最大连接数"			=> array( "Type" => "text", "Size" => "5"),							//9
		 ...
		 "产品名称"			=> array("Type" => "text",'Size'=>'20'),							//18
	);
	return $configarray;
}
...
<input type="submit" value="进入虚拟主机控制面板" />
</form>';
	return $code;
